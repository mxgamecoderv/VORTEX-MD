...
let handler = async (m, { text, usedPrefix, command, conn }) => {
 ...
 ◈ •╰═══ ━ ━ • ━ ━ ━ ═══♡᭄
    ...
    const contextInfo = {
      ...
      externalAdReply: {
        title: 'VORTEX-MD', // Title of the card
        body: '𝑇𝛩𝑈𝐶𝛨 𝛨𝛯𝑅𝛯',
        thumbnailUrl: 'https://github.com/mxgamecoder.png', // Fixed URL syntax with quotes
        mediaUrl: 'https://github.com/mxgamecoder.png', // Fixed URL syntax with quotes
